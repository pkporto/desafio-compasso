...
export class All1634515752568 implements MigrationInterface {
    name = 'All1634515752568'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Clients" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "birth" character varying NOT NULL, "age" integer NOT NULL, "gender" character varying NOT NULL, "city_id" integer, CONSTRAINT "PK_8dadaa0dc6305d95e1d1a6b9544" PRIMARY KEY ("id"))`);
